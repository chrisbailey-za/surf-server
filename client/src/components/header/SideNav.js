	...
	render(){
		...
		return(
		  <ul onClick={this.props.changeVis} id="slide-out" className="side-nav grey lighten-3" style={this.props.vis}>
		    ...
		    <li><Link to="/surf/add">Add a Surf<i className="material-icons cyan-text text-darken-3 right">add_circle</i></Link></li>
		    ...
		    <li><Link to="#">My Notifications<i className="material-icons cyan-text text-darken-3 right">notifications</i></Link></li>
		  </ul>
		)
	}
}
